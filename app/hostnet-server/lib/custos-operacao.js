...
const DATAS_FIXAS = [
  ...
  },
  {
    ...
    categoria: 'Fiscal',
    nota: 'Franklin viu um vencimento em 21/09/2026 e vai pagar pelo Mercado Pago. Valor e tipo da guia NÃO informados — conferir o nome e a competência na própria guia antes de pagar. Pode ser ligado à Dívida Ativa (ver a aba Obrigações CNPJ / MEI), mas não foi confirmado.',
...
const PONTUAIS = [
  ...
  {
    nome: 'Obrigações do CNPJ / MEI (situação na Receita, dívida ativa, o que fazer)',
    nota: 'O resumo completo mora na aba própria (Ajustes → Obrigações CNPJ / MEI — pendências). Aqui ficam só os vencimentos com data (parcelamento do MEI e a guia de 21/09), que geram o aviso.',
    oQueE: 'Em uma frase: o CNPJ deixou de ser MEI em 01/01/2026, há uma Dívida Ativa da União ainda negociável e falta definir com um contador os tributos do regime atual.',
    status: 'urgente: ver a aba Obrigações CNPJ / MEI',
  },
  {
