...
const RECORRENTES_MENSAIS = [
  ...
  },
  {
    ...
    nota: 'plano TEAM · publica TikTok de frank + Kleber · cartão Visa •••• 2936',
    valor: 39,
    moeda: 'USD',
    valorAproxBRL: 200,
    diaVencimento: 21,
...
const PONTUAIS = [
  ...
  },
  {
    ...
    nota: 'pago via Pix em 09/09/2026 · validação de identidade ainda pendente',
    valor: 79,
    moeda: 'BRL',
