...
const { encryptToken, decryptToken } = require('../_lib/token-crypto');
const { refreshAccessToken, publishVideo } = require('../_lib/tiktok');
...
// do Content Posting API, só publica como privado (SELF_ONLY) — ver _lib/tiktok.js.
